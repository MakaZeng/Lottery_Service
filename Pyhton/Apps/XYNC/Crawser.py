...
crawser_url = "http://www.cp098.com/xync/getHistoryData?count=1&t=0.5354527991439386"
...
class Crawser(object):
    ...
    def judge_need_crawser(self):
        ...
        if current - lastTimeSeconds >= timeInset * 60:
            print '幸运农场 ***********需要抓取********** {0} {1} *****'.format(lastTimeSeconds, current)
            return 1
