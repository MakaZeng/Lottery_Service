...
crawser_url = "http://www.cp098.com/gd11x5/getHistoryData?count=1&t=0.5354527991439386"
...
class Crawser(object):
    ...
    def judge_need_crawser(self):
        ...
        if current - lastTimeSeconds >= timeInset * 60:
            print '十一选五 ***********需要抓取********** {0} {1} *****'.format(lastTimeSeconds, current)
            return 1
