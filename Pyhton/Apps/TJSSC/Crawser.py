...
crawser_url = "http://www.cp098.com/tjssc/getHistoryData?count=1&t=0.5354527991439386"
...
class Crawser(object):
    ...
    def judge_need_crawser(self):
        ...
        if current - lastTimeSeconds >= currentInset * 60:
            print '天津时时彩 ***********需要抓取********** {0} {1} *****'.format(lastTimeSeconds, current)
            return 1
